package com.elolympus.views.formcreditcard;
...
@PageTitle("Form Credit Card")
@Route(value = "credit-card-form", layout = MainLayout.class)
@AnonymousAllowed
public class FormCreditCardView extends Div {
    ...
    public FormCreditCardView() {
        addClassName("form-credit-card-view");
