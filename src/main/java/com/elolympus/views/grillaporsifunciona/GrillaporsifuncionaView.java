package com.elolympus.views.grillaporsifunciona;
...
@PageTitle("Grilla por si funciona")
@Route(value = "data-grid", layout = MainLayout.class)
@AnonymousAllowed
public class GrillaporsifuncionaView extends Div {
    ...
    public GrillaporsifuncionaView() {
        addClassName("grillaporsifunciona-view");
        setSizeFull();
        createGrid();
        add(grid);
    }
