...
@PageTitle("Colaboracion")
@Route(value = "collaborative-master-detail/:samplePersonID?/:action?(edit)", layout = MainLayout.class)
@AnonymousAllowed
@Uses(Icon.class)
public class ColaboracionView extends Div implements BeforeEnterObserver {
    ...
    public ColaboracionView(SamplePersonService samplePersonService) {
        this.samplePersonService = samplePersonService;
        addClassNames("colaboracion-view");
...
//        UserInfo userInfo = new UserInfo(UUID.randomUUID().toString(), "Steve Lange");
        ...
        grid.asSingleSelect().addValueChangeListener(event -> {
            if (event.getValue() != null) {
                ...
                clearForm();
                UI.getCurrent().navigate(ColaboracionView.class);
            }
        });
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        ...
        if (samplePersonId.isPresent()) {
            ...
            if (samplePersonFromBackend.isPresent()) {
                ...
                // refresh grid
                refreshGrid();
                event.forwardTo(ColaboracionView.class);
            }
        }
    }
