package com.elolympus.views.editartabla;
...
@PageTitle("Editar Tabla")
@Route(value = "master-detail/:samplePersonID?/:action?(edit)", layout = MainLayout.class)
@AnonymousAllowed
@Uses(Icon.class)
public class EditarTablaView extends Div implements BeforeEnterObserver {
    ...
    public EditarTablaView(SamplePersonService samplePersonService) {
